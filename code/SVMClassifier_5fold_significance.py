...
# data_test
with open('../data/stat_n_hypernym_dbpedia_en/balanced_random_stat_hypernym_dbpedia_en_semantics.csv') as fline,\
        open('../data/statistical_features/balanced_stat_random.csv') as flineX:
    # with open('../data/stat_n_dbpedia_en/filtered_dbpedia_semantics/balanced_random_stat_dbpedia_en_semantics.csv') as fline,\
